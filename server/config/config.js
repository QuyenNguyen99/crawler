...
config.LINK_IMAGE = '/var/www/html/files/crawlersystem/';
...
config.SERVER = {
    'crawlersystem': 'crawlersystem',
    'db2_f9_app_crawler': 'db2_f9_app_crawler',
    'db2_f9_dm_user': 'db2_f9_dm_user',
    'mongo_facebook_10672': 'mongo_facebook_10672',
};
config.MYSQL[config.SERVER['crawlersystem']] = {
    server: '192.168.105.74',
    username: 'five9',
    password: 'five9123',
    database: 'crawler_system',
    reconnectTimeout: 2000
}

config.DB2[config.SERVER['db2_f9_app_crawler']] = {
    server: '192.168.106.100',
    port: 50000,
    username: 'crawlerdev',
    password: 'F69hpsLpSK@123',
    database: 'F9_APP_CRAWLER'
}

config.DB2[config.SERVER['db2_f9_dm_user']] = {
    server: '192.168.106.100',
    port: 50000,
    username: 'dmuser',
    password: 'Dmuser@123456',
    database: 'F9_APP_INSIGHT'
}

config.MONGO[config.SERVER['mongo_facebook_10672']] = {
    server: '192.168.106.72',
    port: '27017',
    username: 'admin',
    password: '5baotDrnioux1gka',
    database: 'facebook',
};
...
config.LINK_REFRESH_SCHEDULE_JOB = 'http://192.168.105.71:6801/crawlersystem/notauthen/restartschedulejob';

config.LINK_FILE_EXCEL = 'C:/project/db/anhvinh/';
