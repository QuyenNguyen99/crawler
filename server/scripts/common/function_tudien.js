...
db.system.js.save({
    _id: 'global_tu_dien_get_word_anh',
    value: function () {
...
db.system.js.save({
    _id: 'global_tu_dien_get_word_viet',
    value: function () {
...
// function global_tu_dien
db.system.js.save({
    _id: 'global_tu_dien_get_word_one',
    value: function () {
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word_one',
    value: function (word) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word',
    value: function (word) {
        ...
        if (!global_tu_dien_word_one_instance.rs_alias[word] && word.length > 2) {
            ...
            for (var k_rs in rs) {
                ...
                if (v_rs.length == length) {
                    if (k_rs.length >= word.length - 1 && k_rs.length <= word.length + 1) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_word_two',
    value: function () {
...
db.system.js.save({
    _id: 'global_tu_dien_get_word_five',
    value: function () {
...
db.system.js.save({
    _id: 'global_tu_dien_get_word_four',
    value: function () {
...
// function global_tu_dien_get_word_three
db.system.js.save({
    _id: 'global_tu_dien_get_word_three',
    value: function () {
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word_two',
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word_three',
    value: function (item1, item2, item3) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word_four',
    value: function (item1, item2, item3, item4) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_same_word_five',
    value: function (item1, item2, item3, item4, item5) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_list_array_sentence',
    value: function (sentence_alias) {
...
db.system.js.save({
    _id: 'global_tu_dien_get_trust_sentence_alias',
    value: function (sentence_alias) {
...
db.system.js.save({
    _id: 'get_tu_dien_from_collection_name',
...
db.system.js.save({
    _id: 'build_tu_dien_by_collection_name',
    value: function (list_collection_name = false, array_keyword = []) {
...
db.system.js.save({
    _id: 'get_data_from_collection_name',
    value: function (collection_name, array_replace) {
        var list_obj_1 = {};
        var list_obj_2 = {};
        var list_obj_3 = {};
        var list_obj_4 = {};
...
db.system.js.save({
    _id: 'global_tu_dien_insert_data_by_array',
    value: function (array_value) {
        var list_obj_1 = {};
        var list_obj_2 = {};
        var list_obj_3 = {};
        var list_obj_4 = {};
...
db.system.js.save({
    _id: 'get_data_from_collection_ref_city_county',
    value: function () {
...
db.system.js.save({
    _id: 'get_data_from_collection_ref_school_1',
    value: function () {
